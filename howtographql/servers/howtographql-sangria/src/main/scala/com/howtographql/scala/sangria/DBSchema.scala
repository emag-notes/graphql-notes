...
object DBSchema {
  ...
  class LinksTable(tag: Tag) extends Table[Link](tag, "LINKS") {
    ...
    override def * = (id, url, description, createdAt).mapTo[Link]
  }
  ...
  class UsersTable(tag: Tag) extends Table[User](tag, "USERS") {
    ...
    override def * = (id, name, email, password, createdAt).mapTo[User]
  }
  ...
  class VotesTable(tag: Tag) extends Table[Vote](tag, "VOTES") {
    ...
    override def * = (id, userId, linkId, createdAt).mapTo[Vote]
  }
